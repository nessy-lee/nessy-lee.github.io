...
typewriter.typeString('hi there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is vanessa.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at sacramento state (go hornets!).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm studying computer science and applied mathematics.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("big fan of pineapple on pizza.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like to bullet journal.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
